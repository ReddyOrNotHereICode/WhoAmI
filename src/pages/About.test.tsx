...
describe('About page tabs and content', () => {
  it('renders all three tabs', () => {
    ...
    expect(screen.getByRole('tab', { name: /beyond the code/i })).toBeInTheDocument();
    expect(screen.getByRole('tab', { name: /my history/i })).toBeInTheDocument();
  });
  ...
  it('shows Beyond the Code tab content when selected', async () => {
    render(<About />);
    await userEvent.click(screen.getByRole('tab', { name: /beyond the code/i }));
    expect(screen.getByText(/in addition to writing code/i)).toBeInTheDocument();
  });
